...
class m181018_070730_create_table_survey_stat extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%survey_stat}}', [
            ...
            'survey_stat_assigned_at' => $this->timestamp()->defaultValue('0'),
            'survey_stat_started_at' => $this->timestamp()->defaultValue('0'),
            'survey_stat_updated_at' => $this->timestamp()->defaultValue('0'),
            'survey_stat_ended_at' => $this->timestamp()->defaultValue('0'),
