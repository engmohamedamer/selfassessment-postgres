...
$this->title = Yii::t('backend', 'Tamkeen Adminstrators');
...
<div class="content-header">
                <div>
                <div class="">
                    <h1><?= Yii::t('common', 'Tamkeen Adminstrators') ?></h1>
                </div>
                <div class=" actionBtns">
                    <a href="/user/create" class="btn btn-success"><i class="icofont-plus mr-2 ml-2"></i> <?= Yii::t('backend','Create New Adminstrators') ?></a>
