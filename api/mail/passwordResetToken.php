        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="right" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
              <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">تغيير كلمة المرور</h1>
            </td>
          </tr>
        </table>
        <!--[if (gte mso 9)|(IE)]>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="right" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">
                بالضغط علي الزر التالي يمكنك من تغيير كلمة المرور الخاصة بحسابك لدينا. اذا لم تقم بطلب تغيير كلمة المرور يمكنك تجاهل الطلب والتواصل معنا.
                </p>
            </td>
          </tr>
          <!-- end copy -->
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="<?= $resetLink ?>" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">تغيير كلمة المرور</a>
                        </td>
                      </tr>
                    </table>
                  </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#F4F6F9" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">
                لقد وصلك هذا البريد الإلكتروني بناء علي طلبكم بتغيير كلمة المرور الخاصة بحسابك.  اذا لم تقم بطلب تغيير كلمة المرور يمكنك تجاهل الطلب والتواصل معنا.
                </p>
            </td>
          </tr>
          <!-- end permission -->
